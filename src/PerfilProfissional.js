      ...
      <form onSubmit={handleSubmit(onSubmit)} className="perfil-form">
        ...
        <div className="form-section">
          ...
          <textarea
            ...
            className={errors.biografia ? 'error' : ''}
          ></textarea>
          {errors.biografia && (
        ...
        <div className="form-section">
          ...
          <div className="habilidades-grid">
            {habilidadesDisponiveis.map((habilidade) => (
              <div key={habilidade} className="habilidade-item">
                <input
                  type="checkbox"
                  id={habilidade}
                  value={habilidade}
          ...
          {errors.habilidades && (
            <span className="error-message">{errors.habilidades.message}</span>
          )}
        </div>
        ...
        <div className="form-section">
          ...
          <div className="form-group">
            <input
              type="checkbox"
              id="disponivel_para_servicos"
              {...register('disponivel_para_servicos')}
            />
            <label htmlFor="disponivel_para_servicos">Disponível para novos serviços</label>
          </div>
        </div>

        <button type="submit" className="save-button" disabled={isSaving || !isDirty}>
